...
model_branch.load_weights('/data/stars/user/rdai/smarthomes/i3d/i3d/weights_Blurred_i3d_without_window/epoch_24.hdf5')
...
train_generator = DataLoader_video_train('/data/stars/user/sdas/smarthomes_data/splits/train_CS.txt',version, batch_size = batch_size)
val_generator = DataLoader_video_train('/data/stars/user/sdas/smarthomes_data/splits/validation_CS.txt', version, batch_size = batch_size)
test_generator = DataLoader_video_test('/data/stars/user/sdas/smarthomes_data/splits/test_CS.txt', version, batch_size = batch_size)
...
with open(model_name+"_CS_result.txt", "a+") as f:
