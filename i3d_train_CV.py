...
#train - test!
test_generator = DataLoader_video_train('/data/stars/user/sdas/smarthomes_data/splits/test_CV.txt', version, batch_size = batch_size)
...
with open(model_name+"CV.json", "a+") as f:
